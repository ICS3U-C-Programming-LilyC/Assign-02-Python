...
def main():
    ...
    print(
        "This program will calculates the surface area and volume of a right cylinder."
    )

    # Telling the user the 3 options they can choose from for their calculation.
    ...
    # Using if then, elif and else to allow the user to choose from the unit options.
    ...
    # Error checking for an input of 0, using an if statement.
    ...
    # Printing the volume and surface area of the cylinder.
        ...
        print(
            "The surface area of the right cylinder is = {:.2f} {}^2".format(
                surface_area, unit
            )
        )
